...
public class UserController {
	 ...
	 * 
	 * @param registerRequest The form supplying an email, username, password, first
	 *                        name, and last name.
	 * @return A response entity indicating successful registration with a message
	 *         and Http status code. This body of this response entity is the value
	 *         of 'data' on the front end app.
	 */
	@PostMapping("/signup")
	 ...
	 * 
	 * @param loginRequest The form supplying a username and password for
	 *                     authentication.
	...
	/**
	 * Maps the DELETE request to delete a product from the user's Favorite Products
	 * list.
	 * 
	...
	public ResponseEntity<String> deleteFavProduct(@Param("productProdNum") String productProdNum,
